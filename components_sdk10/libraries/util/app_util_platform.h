...
/* SDK12 uses APP_IRQ_PRIORITY_LOWEST; nRF51 SWI runs at priority 3 */
#define APP_IRQ_PRIORITY_LOWEST  APP_IRQ_PRIORITY_LOW
...
/* Compatibility shim: SDK12 log headers use NRF_BREAKPOINT_COND */
#ifndef NRF_BREAKPOINT_COND
#ifdef DEBUG
#define NRF_BREAKPOINT_COND do { __BKPT(0); } while(0)
#else
